...
- Remove the empty label warning (no empty labels used).
- Perfectly horizontally align buttons centered under the filters.
- Keep all your functionality and styling intact.

If you want me to help further with styling or anything else, just ask!
